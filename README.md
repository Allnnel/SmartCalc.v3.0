...
Фронтэнд написан с помощью JavaFX, а бэкэнд - на языке C, и они подключены с помощью динамической библиотеки. Для запуска проекта необходимо предварительно выполнить сборку динамической библиотеки с помощью Makefile, выбрав цель, соответствующую операционной системе пользователя.
